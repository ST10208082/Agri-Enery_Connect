        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Suburb = table.Column<string>(type: "nvarchar(100)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FarmerCategoryId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FarmerProduct", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FarmerProduct_FarmerCategory_FarmerCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FarmerProduct_FarmerCategoryId",
                table: "FarmerProduct",
